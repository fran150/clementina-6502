...
var charA00 []string = []string{
	...
	" ", " ", "$", "4", "D", "T", "d", "t", " ", " ", "､", "ｴ", "ﾄ", "ﾔ", "μ", "Ω",
	" ", " ", "%", "5", "E", "U", "e", "u", " ", " ", "･", "ｵ", "ﾅ", "ﾕ", "σ", "ü",
	" ", " ", "&", "6", "F", "V", "f", "v", " ", " ", "ｦ", "ｶ", "ﾆ", "ﾖ", "ρ", "Σ",
	" ", " ", "'", "7", "G", "W", "g", "w", " ", " ", "ｧ", "ｷ", "ﾇ", "ﾗ", "g", "π",
	" ", " ", "(", "8", "H", "X", "h", "x", " ", " ", "ｨ", "ｸ", "ﾈ", "ﾘ", "√", "x̄",
	" ", " ", ")", "9", "I", "Y", "i", "y", " ", " ", "ｩ", "ｹ", "ﾉ", "ﾙ", "⁻¹", "y",
	" ", " ", "*", ":", "J", "Z", "j", "z", " ", " ", "ｪ", "ｺ", "ﾊ", "ﾚ", "j", "千",
	" ", " ", "+", ";", "K", "[", "k", "{", " ", " ", "ｫ", "ｻ", "ﾋ", "ﾛ", "ˣ", "万",
	" ", " ", ",", "<", "L", "¥", "l", "|", " ", " ", "ｬ", "ｼ", "ﾌ", "ﾜ", "¢", "円",
