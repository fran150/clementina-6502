...
func (c *ClementinaGPIOComputer) Tick(context *common.StepContext) {
...
func (c *ClementinaGPIOComputer) GetProgramCounter() uint16 {
...
func (c *ClementinaGPIOComputer) Reset(status bool) {
...
func (c *ClementinaGPIOComputer) getPotentialOperators(programCounter uint16) [2]uint8 {
	...
	case programCounter >= 0xE000:
		if c.circuit.picoHiRAME.Status() {
			portA := c.circuit.portABus.Read()
			portA16Bits := c.mappers.portA.MapFromSource([]uint8{portA})
...
func (c *ClementinaGPIOComputer) BaseRamPoke(address uint16, value uint8) {
...
//   - value: The 8-bit value to write
func (c *ClementinaGPIOComputer) ExRamPoke(address uint16, bank uint8, value uint8) {
	bank = bank & 0x1F
...
//   - value: The 8-bit value to write
func (c *ClementinaGPIOComputer) HiRamPoke(address uint16, bank uint8, value uint8) {
	bank = (bank & 0x03) << 5
