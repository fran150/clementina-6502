...
func createMenuOptions(console *clementinaGPIOEmulatorConsole, emulator *clementinaGPIOEmulator) []*ui.OptionsWindowMenuOption {
...
func createMemoryWindowSubMenu(console *clementinaGPIOEmulatorConsole) []*ui.OptionsWindowMenuOption {
	return []*ui.OptionsWindowMenuOption{
		{
			Key:            tcell.KeyUp,
			KeyName:        "Up",
