...
// // TViewConsoleOld provides a tview-based console implementation.
// type TViewConsoleOld struct {
// }

// // NewTViewConsoleOld creates a new tview-based console.
// //
// // Returns:
// //   - A pointer to the initialized TViewConsoleOld
// func NewTViewConsoleOld() *TViewConsoleOld {
// 	windowManager := NewWindowManager()
// 	navigationManager := NewNavigationManager()
// 	console := NewConsole(windowManager, navigationManager)
// 	app := tview.NewApplication()

// 	TViewConsoleOld := &TViewConsoleOld{
// 		console:       console,
...
// 	TViewConsoleOld.inputHandler = &DefaultInputHandler{
// 		windowManager: windowManager,
// 		console:       TViewConsoleOld,
// 	}

// 	// Configure the framework
// 	app.SetInputCapture(TViewConsoleOld.inputHandler.HandleKey)
// 	app.EnableMouse(true)
// 	app.EnablePaste(true)

// 	// Set the pages as the root of the tview app
// 	app.SetRoot(TViewConsoleOld.pages, true)

// 	return TViewConsoleOld
// }

// func (tc *TViewConsoleOld) GetWindowManager() WindowManager {
// 	return tc.windowManager
// }

// func (tc *TViewConsoleOld) SetRoot(root tview.Primitive) {
...
// func (tc *TViewConsoleOld) AddWindow(key string, window terminal.Window) {
...
// func (tc *TViewConsoleOld) GetWindow(key string) terminal.Window {
...
// func (tc *TViewConsoleOld) RemoveWindow(key string) {
...
// func (tc *TViewConsoleOld) ShowWindow(windowKey string) {
...
// func (tc *TViewConsoleOld) ScrollUp(step uint32) {
...
// func (tc *TViewConsoleOld) Run() error {
// 	return tc.app.Run()
// }

// // Stop stops the console application.
// func (tc *TViewConsoleOld) Stop() {
// 	tc.app.Stop()
// }
...
// func (tc *TViewConsoleOld) Draw(context *common.StepContext) {
...
// // Parameters:
// //   - context: The current step context
// func (tc *TViewConsoleOld) Tick(context *common.StepContext) {
...
// func (tc *TViewConsoleOld) GetActiveWindow() string {
...
// func (tc *TViewConsoleOld) GetPages() *tview.Pages {
// 	return tc.pages
// }
...
// func (tc *TViewConsoleOld) GetConsole() *Console {
// 	return tc.console
// }
