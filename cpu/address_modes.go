...
func CreateAddressModesSet() *AddressModeSet {
	...
	data := []AddressModeData{
		...
		{AddressModeAbsoluteX, "a,x", "$%#x, X", []MicroInstruction{ReadFromProgramCounter + IntoInstructionRegisterLSB, ReadFromProgramCounter + IntoInstructionRegisterMSB + AddXToInstructionRegister, ReadFromInstructionRegister + IntoDataRegister + CycleAction}, 3},
		{AddressModeAbsoluteY, "a,y", "$%#x, Y", []MicroInstruction{ReadFromProgramCounter + IntoInstructionRegisterLSB, ReadFromProgramCounter + IntoInstructionRegisterMSB + AddYToInstructionRegister, ReadFromInstructionRegister + IntoDataRegister + CycleAction}, 3},
