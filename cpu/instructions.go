...
func CreateInstructionSet() *CpuInstructionSet {
	var data = []CpuInstructionData{
		...
		{0x84, STY, ActionSTY, AddressModeZeroPage},
		{0x85, STA, ActionSTA, AddressModeZeroPage},
		{0x86, STX, ActionSTX, AddressModeZeroPage},
		...
		{0x8C, STY, ActionSTY, AddressModeAbsolute},
		{0x8D, STA, ActionSTA, AddressModeAbsolute},
		{0x8E, STX, ActionSTX, AddressModeAbsolute},
		...
		{0x9D, STA, ActionSTA, AddressModeAbsoluteX},
