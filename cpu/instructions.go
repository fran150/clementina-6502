...
func CreateInstructionSet() *CpuInstructionSet {
	var data = []CpuInstructionData{
		...
		{0x04, TSB, AddressModeZeroPageRMW},
		{0x05, ORA, AddressModeZeroPage},
		{0x06, ASL, AddressModeZeroPageRMW},
		{0x07, RMB0, AddressModeZeroPageRMW},
		{0x08, PHP, AddressModeImplicit},
		{0x09, ORA, AddressModeImmediate},
		{0x0A, ASL, AddressModeAccumulator},
		{0x0C, TSB, AddressModeAbsoluteRMW},
		{0x0D, ORA, AddressModeAbsolute},
		{0x0E, ASL, AddressModeAbsoluteRMW},
		...
		{0x14, TRB, AddressModeZeroPageRMW},
		{0x15, ORA, AddressModeZeroPageX},
		{0x16, ASL, AddressModeZeroPageXRMW},
		{0x17, RMB1, AddressModeZeroPageRMW},
		{0x18, CLC, AddressModeImplicit},
		{0x19, ORA, AddressModeAbsoluteY},
		{0x1A, INC, AddressModeAccumulator},
		{0x1C, TRB, AddressModeAbsoluteRMW},
		{0x1D, ORA, AddressModeAbsoluteX},
		{0x1E, ASL, AddressModeAbsoluteXRMW},
		...
		{0x26, ROL, AddressModeZeroPageRMW},
		{0x27, RMB2, AddressModeZeroPageRMW},
		...
		{0x2E, ROL, AddressModeAbsoluteRMW},
		...
		{0x36, ROL, AddressModeZeroPageXRMW},
		{0x37, RMB3, AddressModeZeroPageRMW},
		...
		{0x3E, ROL, AddressModeAbsoluteXRMW},
		...
		{0x46, LSR, AddressModeZeroPageRMW},
		{0x47, RMB4, AddressModeZeroPageRMW},
		...
		{0x4E, LSR, AddressModeAbsoluteRMW},
		...
		{0x66, ROR, AddressModeZeroPageRMW},
		{0x67, RMB6, AddressModeZeroPageRMW},
		...
		{0x6E, ROR, AddressModeAbsoluteRMW},
		...
		{0x76, ROR, AddressModeZeroPageXRMW},
		{0x77, RMB7, AddressModeZeroPageRMW},
		...
		{0x7E, ROR, AddressModeAbsoluteXRMW},
		...
		{0x87, SMB0, AddressModeZeroPageRMW},
		...
		{0x97, SMB1, AddressModeZeroPageRMW},
		...
		{0xA7, SMB2, AddressModeZeroPageRMW},
		...
		{0xB7, SMB3, AddressModeZeroPageRMW},
		...
		{0xC6, DEC, AddressModeZeroPageRMW},
		{0xC7, SMB4, AddressModeZeroPageRMW},
		...
		{0xCE, DEC, AddressModeAbsoluteRMW},
		...
		{0xD6, DEC, AddressModeZeroPageXRMW},
		{0xD7, SMB5, AddressModeZeroPageRMW},
		...
		{0xDE, DEC, AddressModeAbsoluteXRMWM},
		...
		{0xE6, INC, AddressModeZeroPageRMW},
		{0xE7, SMB6, AddressModeZeroPageRMW},
		...
		{0xEE, INC, AddressModeAbsoluteRMW},
